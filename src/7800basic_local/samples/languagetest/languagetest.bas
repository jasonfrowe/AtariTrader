 ...
 rem *** capabilities break with 7800basic code updates.
...
bailout
 ...
 if r >= 4  then goto bailout
 if r <= 4  then goto bailout
 if r=4     then goto bailout

 rem ********** test the new incbasic functionality...
 incbasic include_01.bas

 rem ********** test the new rerand functionality...
 rerand
 rem done
